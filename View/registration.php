    ...
    <div class="col-md-6">
         <div class="row myborder">
            ...
            <div class="input-group margin-bottom-20">
                ...
                <input size="60" maxlength="255" class="form-control" placeholder="Password" name="person_password" id="person_password" type="password"  pattern=".{6,}" title="Six or more characters"required>                                    </div>

                <div class="input-group margin-bottom-20">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-lock mycolor"></i></span>
                    <input size="60" maxlength="255" class="form-control" placeholder="Password Again" name="person_password2" id="person_password2" type="password"  pattern=".{6,}" title="Six or more characters" required>                                    </div>
